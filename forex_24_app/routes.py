...
from forex_24_app import app, db, bcrypt
from forex_24_app.forms import AdminForm, LoginForm, PostForm, UpdatePostForm, PostSignalForm, UpdatePostSignalForm
from forex_24_app.models import Admin, Post, Post_Signals, Feedback
